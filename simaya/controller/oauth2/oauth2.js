module.exports = function(app) {
  ...
  // xauth
  // curl -L -u "1:ayam" -d "username=user&password=password" "http://localhost:3000/xauth/authorize?response_type=code&redirect_uri=/xauth/callback&client_id=1&state=user"
  var xauthorization = [
    filter,
    userAuth,
    server.authorization(serverAuthorization),
